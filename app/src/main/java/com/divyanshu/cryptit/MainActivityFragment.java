...
public class MainActivityFragment extends Fragment implements CryptoThread.ProgressDisplayer {
    ...
    private Boolean IS_USING_FP = false;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        goldfinger = new Goldfinger.Builder(view.getContext()).build();
        ...
        fpButton = view.findViewById(R.id.fp_button);
            ...
            fpButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    FingerprintDialog.initialize(getActivity())
                            .title("Please validate fingerprint")
                            .message("Press your finger now.")
                            .callback(new FingerprintDialogCallback() {
                                @Override
                                public void onAuthenticationSucceeded() {
                                    IS_USING_FP = true;
                                    Toast.makeText(getActivity(), "Fingerprint authenticated.", Toast.LENGTH_SHORT).show();
                                }
        ...
        * */
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if (tab.getPosition() == 0) enableEncryptionMode();
                else enableDecryptionMode();
            }
